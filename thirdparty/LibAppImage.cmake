...
if (NOT libappimage_FOUND)
    ...
    message("libappimage INSTALL_DIR ${INSTALL_DIR} BINARY_DIR ${BINARY_DIR}")
    set(LIBAPPIMAGE_INSTALL_DIR ${INSTALL_DIR})

    set(LIBAPPIMAGE_LIBRARIES ${LIBAPPIMAGE_INSTALL_DIR}${CMAKE_INSTALL_PREFIX}/lib/libappimage.so)
    set(LIBAPPIMAGE_INCLUDE_DIRS ${LIBAPPIMAGE_INSTALL_DIR}${CMAKE_INSTALL_PREFIX}/include/)
